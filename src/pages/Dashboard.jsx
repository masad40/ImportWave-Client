...
const Dashboard = () => {
  ...
  const menuItems = [
    { to: "/dashboard/myExport", label: "My Exports", icon: <UploadCloud className="w-6 h-6" /> },
    { to: "/dashboard/myImport", label: "My Imports", icon: <DownloadCloud className="w-6 h-6" /> },
    { to: "/dashboard/addExport", label: "Add Export", icon: <PlusCircle className="w-6 h-6" /> },
    { to: "/dashboard/profile", label: "My Profile", icon: <User className="w-6 h-6" /> },
  ];
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <div className="lg:hidden fixed top-4 left-4 z-50">
        <button
          ...
          className="btn btn-circle btn-ghost bg-white dark:bg-gray-800 shadow-lg"
        >
      ...
      <div
        className={`fixed inset-y-0 left-0 z-40 w-72 bg-white dark:bg-gray-900 shadow-2xl transform transition-transform duration-300 ease-in-out ${
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-t dark:border-gray-800">
            <button
              ...
              className="w-full flex items-center justify-center gap-4 px-6 py-4 bg-red-600 hover:bg-red-700 text-white font-bold text-lg rounded-2xl shadow-xl transition"
            >
